...
public class ConfigInstaller extends JFrame  {
	...
	public ConfigInstaller(SelectTar selctar) {
		...
		btnNext.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String msg ="Hadoop Installed Successfully,Login to user to start the services";
				JOptionPane.showMessageDialog(null, msg, "Thank You!",JOptionPane.INFORMATION_MESSAGE);
				System.exit(0);
			}
		});
		...
		btnInstall.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(Mode==0)
				{
					...
					if(chckbxCreateNewUser.isSelected() && Arrays.equals(pwdHadoop.getPassword(), pwdHadoop_1.getPassword()))
						{
					...
					else if(!chckbxCreateNewUser.isSelected())
						{
							b.ssh_services();
							b.install_hadoop(selctar.tarpath, selctar.filename,selctar.parpath);						
							b.setup_env();
