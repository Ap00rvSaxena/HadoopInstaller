...
public class Basic {
	...
	public void copyFileUsingFileStreams()throws IOException {
		ClassLoader classLoader = getClass().getClassLoader();
        String target ="/home/"+ user +"/Desktop/";
        File sourceFile = new File(classLoader.getResource("HadoopServices.jar").getFile()); 
